...
if (isRegisteredUser(user)) {
  ...
  if (isValidEmail(user) && isValidPassword(password)) {
    console.group("User signed up")
  } else if (!isValidEmail(user)) {
    console.log('Email must be a valid persevere email')
  }
  else if (isValidPassword(password)) {
    console.log('Password must be 8 characters and contain 1 upper and 1 lowercase letter')
  }
}
